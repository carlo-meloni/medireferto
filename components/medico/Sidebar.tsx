...
export default function Sidebar({ doctor }: SidebarProps) {
  ...
  return (
    <>
      ...
      {!mobileOpen && (
        <button
          className="fixed top-4 left-4 z-30 p-2 rounded-lg bg-white shadow-sm border border-zinc-200 text-zinc-600 hover:text-zinc-900 transition-colors md:hidden"
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 h-16 border-b border-zinc-100 shrink-0">
          ...
          <button
            ...
            className={`hidden md:flex p-1.5 rounded-lg text-zinc-400 hover:text-zinc-700 hover:bg-zinc-100 transition-colors duration-150 ${
          ...
          <button
            onClick={() => setMobileOpen(false)}
            className="ml-auto p-1.5 rounded-lg text-zinc-400 hover:text-zinc-700 hover:bg-zinc-100 transition-colors md:hidden"
        ...
        <div className="px-3 pb-4 pt-3 border-t border-zinc-100 flex flex-col gap-0.5 shrink-0">
          ...
          {/* Doctor profile */}
          <div className={`flex items-center gap-2.5 px-3 py-2 rounded-lg ${collapsed ? 'md:justify-center' : ''}`}>
          ...
          >
            ...
            {(!collapsed || mobileOpen) && <span>Esci</span>}
          </button>
        </div>
      </aside>
    </>
